...
namespace FlightAlert.AirportDataSet1TableAdapters {
...
SELECT [Plane ID], Name, Delayed, Destination, [Arriving From], [Arrival DateTime], [Depature DateTime] FROM Plane WHERE ([Plane ID] = @Plane_ID)";
        ...
        public virtual int Fill(AirportDataSet1.PlaneDataTable dataTable) {
        ...
        public virtual AirportDataSet1.PlaneDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AirportDataSet1.PlaneDataTable dataTable = new AirportDataSet1.PlaneDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AirportDataSet1.PlaneDataTable dataTable) {
