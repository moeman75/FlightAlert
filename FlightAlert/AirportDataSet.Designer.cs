...
namespace FlightAlert {
    ...
    public partial class AirportDataSet : global::System.Data.DataSet {
        ...
        public partial class MajorAirportsDataTable : global::System.Data.TypedTableBase<MajorAirportsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MajorAirportsRow AddMajorAirportsRow(int Airport_ID, string Name, double Lat, double Lon) {
...
namespace FlightAlert.AirportDataSetTableAdapters {
    ...
    public partial class MajorAirportsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MajorAirports] ([Airport ID], [Name], [Lat], [Lon]) VALUES (@A" +
                "irport_ID, @Name, @Lat, @Lon);\r\nSELECT [Airport ID], Name, Lat, Lon FROM MajorAi" +
                "rports WHERE ([Airport ID] = @Airport_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[MajorAirports] SET [Airport ID] = @Airport_ID, [Name] = @Name, [Lat] = @Lat, [Lon] = @Lon WHERE (([Airport ID] = @Original_Airport_ID) AND ([Name] = @Original_Name) AND ([Lat] = @Original_Lat) AND ([Lon] = @Original_Lon));
SELECT [Airport ID], Name, Lat, Lon FROM MajorAirports WHERE ([Airport ID] = @Airport_ID)";
        ...
        public virtual int Fill(AirportDataSet.MajorAirportsDataTable dataTable) {
        ...
        public virtual AirportDataSet.MajorAirportsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AirportDataSet.MajorAirportsDataTable dataTable = new AirportDataSet.MajorAirportsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AirportDataSet.MajorAirportsDataTable dataTable) {
        ...
        public virtual int Insert(int Airport_ID, string Name, double Lat, double Lon) {
        ...
        public virtual int Update(int Airport_ID, string Name, double Lat, double Lon, int Original_Airport_ID, string Original_Name, double Original_Lat, double Original_Lon) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((double)(Original_Lat));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((double)(Original_Lon));
        ...
        public virtual int Update(string Name, double Lat, double Lon, int Original_Airport_ID, string Original_Name, double Original_Lat, double Original_Lon) {
            return this.Update(Original_Airport_ID, Name, Lat, Lon, Original_Airport_ID, Original_Name, Original_Lat, Original_Lon);
        }
    }
